...
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      className="w-full sm:w-auto min-h-11 flex items-center justify-center gap-2 rounded-full bg-[#25D366] hover:bg-[#1ebe5b] text-white font-medium text-sm px-5 py-2.5 shadow-md transition-colors duration-200 active:scale-95"
    >
      <svg viewBox="0 0 24 24" width="18" height="18" fill="white" aria-hidden="true" className="flex-shrink-0">
