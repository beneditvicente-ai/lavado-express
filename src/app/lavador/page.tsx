...
export default async function LavadorPage() {
  ...
  return (
    <main className="flex-1 max-w-2xl mx-auto w-full p-6 space-y-6">
      ...
      <Link href="/lavador/pedidos" className="block border rounded-md px-4 py-3 text-center font-medium">
        Mis turnos
      </Link>

      <div className="border rounded-md p-4 bg-neutral-50">
        <p className="text-neutral-600">
          Completá esto para que los clientes puedan encontrarte y reservar
          con vos.
        </p>
      </div>
